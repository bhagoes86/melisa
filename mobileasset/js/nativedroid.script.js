$(document).on("pageinit", function() {
    ...
    nativeDroid = {basic: {dateFormat: {language: {set: "en", type: "short", en: {dayShort: ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"], dayLong: ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"], monthShort: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], monthLong: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"], order: function(e, t, n, i, o) {
                            return t + ", " + o + " " + n
                        }}, de: {dayShort: ["So", "Mo", "Di", "Mi", "Do", "Fr", "Sa"], dayLong: ["Sonntag", "Montag", "Dienstag", "Mittwoch", "Donnerstag", "Freitag", "Samstag"], monthShort: ["Jan", "Feb", "Mrz", "Apr", "Mai", "Jun", "Jul", "Aug", "Sep", "Okt", "Nov", "Dez"], monthLong: ["Januar", "Februar", "M&auml;rz", "April", "Mai", "Juni", "Juli", "August", "September", "Oktober", "November", "Dezember"], order: function(e, t, n, i, o, a) {
                            return t + ", " + n + ". " + o + " " + a
                ...
                $(window).scrollTop(1), $(window).on("scroll", function() {
            ...
            }}, design: {animation: {delayedFadeIn: function() {
                ...
                }}, progress: {loaded: !1, ini: function() {
                    ...
                    e.addClass("nativeDroidCards"), e.find(" > li").each(function() {
                        ...
                        console.log("sports")
                    }}}, twitter: {container: !1, results: {count: 0, rpmin: 0, first: 0, last: 0, pendingResults: [], update: function(e) {
                    ...
                    }}, refresh: {url: !1, time: !1, auto_delay: 45e3, load: function() {
                ...
                }, apiUrl: {search: "http://search.twitter.com/search.json"}, load: function(e) {
                    ...
                    if (e && (nativeDroid.plugins.twitter.refresh.url = e.refresh_url ? e.refresh_url : nativeDroid.plugins.twitter.refresh.url, e = e.results ? e.results : e, anz = e.length, nativeDroid.plugins.twitter.results.update(anz), anz > 0))
                        for (i = 0; anz > i; i++)
                            entity = e[i], html = "", html += "<li>", html += "<img src='" + entity.profile_image_url + "'>", html += "<h2><a href='http://www.twitter.com/" + entity.from_user + "' data-ajax='false' target='_blank'>" + entity.from_user_name + "</a></h2>", html += "<p>" + entity.text + "</p>", html += "</li>", toTimer = 1e3 * i, nativeDroid.plugins.twitter.results.pendingResults.splice(0, 0, html)
                }}, flickr: {container: !1, apiKey: !1, dragStarted: !1, dragStartX: 0, lastSwipe: !1, request: {queryData: !1, apiUrl: "http://api.flickr.com/services/rest/?method=flickr.", requestUrl: !1, cat: !1, method: !1, parameter: !1, prepareQuery: function() {
                    ...
                    $(".ui-page").on("click", ".nativeDroidGallery li:not('.active')", function() {
                        ...
                        }, 1)) : $(this).addClass("active"), $(this).css({"background-image": "url('" + $(this).data("image-thumb") + "')"}), $(this).css({"background-image": "url('" + $(this).data("image-large") + "')"})
                        ...
                        t.addClass("slideLeft"), setTimeout(function() {
                            t.removeClass("active").css({left: "auto"}).removeClass("slideLeft").removeClass("slideRight")
                        }, 500), next = $(this).next("li"), 1 == next.length ? (nativeDroid.plugins.flickr.lastSwipe = "left", next.trigger("click")) : (nativeDroid.plugins.flickr.lastSwipe = !1, $(".overlay").hide()), thumb = t.data("image-thumb"), $(this).css({"background-image": "url('" + thumb + "')"})
                    }).on("swiperight", ".nativeDroidGallery li.active:not('.zoom')", function(e) {
                        e.preventDefault();
                        var t = $(this);
                        t.addClass("slideRight"), setTimeout(function() {
                            t.removeClass("active").css({left: "auto"}).removeClass("slideLeft").removeClass("slideRight")
                        }, 500), prev = $(this).prev("li"), 1 == prev.length ? (nativeDroid.plugins.flickr.lastSwipe = "right", prev.trigger("click")) : (nativeDroid.plugins.flickr.lastSwipe = !1, $(".overlay").hide()), thumb = t.data("image-thumb"), $(this).css({"background-image": "url('" + thumb + "')"})
                        ...
                        $(this).removeClass("noTransition").css({left: "auto"}), nativeDroid.plugins.flickr.dragStarted = !1
                    ...
                    setTimeout(function() {
                        e.append(t)
                ...
                }, parseByType: {photos: {search: function(e) {
                            if (nativeDroid.plugins.flickr.container.addClass("nativeDroidGallery"), nativeDroid.plugins.flickr.container.append("<div class='overlay'></div>"), e.photos) {
                                ...
                                for (i = 0; e.photos.photo.length > i; i++)
                                    p = e.photos.photo[i], html = "<li style='background-image:url(\"" + p.url_t + "\")' data-image-large='" + p.url_l + "' data-image-thumb='" + p.url_t + "'><div class='closeTrigger'><i class='icon-remove'></i> close</div><span>" + p.title + "</span></li>", nativeDroid.plugins.flickr.delayedAppend(t, html, 50 * i)
                            }
                        }}, photosets: {getList: function(e) {
                            if (nativeDroid.plugins.flickr.container.addClass("nativeDroidGallerySetList"), e.photosets) {
                                html = "";
                                var t = nativeDroid.plugins.flickr.container;
                                for (i = 0; e.photosets.photoset.length > i; i++)
                                    set = e.photosets.photoset[i], html += "<li class='flickrGalleryLoad'><a href='#load-photoset-flickr-" + set.id + "' data-photoset-id='" + set.id + "' data-ajax='false'>" + set.title._content + "</a></li>";
                            ...
                            if ($(".nativeDroidGallerySetList").addClass("slideLeft"), e.photoset) {
                                var t = "";
                                for (t += "<div class='nativeDroidGallerySet'><ul class='nativeDroidGallery'>", i = 0; e.photoset.photo.length > i; i++)
                                    p = e.photoset.photo[i], t += "<li style='background-image:url(\"" + p.url_t + "\")' data-image-large='" + p.url_l + "' data-image-thumb='" + p.url_t + "'><div class='closeTrigger'><i class='icon-remove'></i> close</div><span>" + p.title + "</span></li>";
                ...
                }}, gallery: {lastSwipe: !1, dragStarted: !1, dragStartX: 0, bindEvents: function() {
                    $(".ui-page").on("click", ".nativeDroidGallery li:not('.active')", function() {
                        ...
                        t.addClass("slideLeft"), setTimeout(function() {
                            t.removeClass("active").css({left: "auto"}).removeClass("slideLeft").removeClass("slideRight")
                        }, 500), next = $(this).next("li"), 1 == next.length ? (nativeDroid.plugins.gallery.lastSwipe = "left", next.trigger("click")) : (nativeDroid.plugins.gallery.lastSwipe = !1, $(".overlay").hide()), thumb = t.data("image-thumb"), $(this).css({"background-image": "url('" + thumb + "')"})
                    }).on("swiperight", ".nativeDroidGallery li.active:not('.zoom')", function(e) {
                        e.preventDefault();
                        var t = $(this);
                        t.addClass("slideRight"), setTimeout(function() {
                            t.removeClass("active").css({left: "auto"}).removeClass("slideLeft").removeClass("slideRight")
                        }, 500), prev = $(this).prev("li"), 1 == prev.length ? (nativeDroid.plugins.gallery.lastSwipe = "right", prev.trigger("click")) : (nativeDroid.plugins.gallery.lastSwipe = !1, $(".overlay").hide()), thumb = t.data("image-thumb"), $(this).css({"background-image": "url('" + thumb + "')"})
                    }).on("mousedown touchstart", ".nativeDroidGallery li.active:not('.zoom')", function(e) {
                        ...
                        $(this).removeClass("noTransition").css({left: "auto"}), nativeDroid.plugins.gallery.dragStarted = !1
                    }).on("mousemove touchmove", ".nativeDroidGallery li.active:not('.zoom')", function(e) {
                ...
                }}, splashscreen: {container: !1, background: !1, time: 3, animation: !1, bindEvents: function() {
                }, create: function() {
                    var e = nativeDroid.plugins.splashscreen.container, t = nativeDroid.plugins.splashscreen.background, n = nativeDroid.plugins.splashscreen.animation;
                    t && (e.addClass("nativeDroidSplashscreen").css({"background-image": "url('" + t + "')"}), delay = 1e3 * nativeDroid.plugins.splashscreen.time, setTimeout(function() {
                ...
                }}, lockscreen: {container: !1, background: !1, delay: 25, display: !1, lastactivity: e, animation: "fadeOut", bindEvents: function() {
                    ...
                    var e = nativeDroid.plugins.lockscreen.container, t = nativeDroid.plugins.lockscreen.background;
                    nativeDroid.plugins.lockscreen.animation, t && e.addClass("nativeDroidLockscreen").css({"background-image": "url('" + t + "')"})
                }, ini: function(e) {
                ...
                }}, homescreen: {container: !1, background: !1, currentslide: 1, dragStartX: 0, dragStated: !1, slides: !1, bindEvents: function() {
                    ...
                    }), $("body,.ui-page,.ui-body,.ui-content").css({overflow: "hidden"})
                    ...
                    var i = "swipeleft" == n ? "rightNoTransition" : "leftNoTransition", o = $(".nativeDroidHomescreen div[data-nativedroid-screenslide-idx='" + t + "']");
                    ...
                    obj = nativeDroid.plugins.homescreen.container, obj.addClass("nativeDroidHomescreen"), bg = nativeDroid.plugins.homescreen.background, bg && obj.css({"background-image": "url('" + bg + "')"}), i = 1, obj.find("[data-nativedroid-role='screenslide']").each(function() {
                    ...
                    if (total = nativeDroid.plugins.homescreen.slides, current = nativeDroid.plugins.homescreen.currentslide, total > 1) {
                        for (html = "<div class='nativeDroidScreenSlideIndicators'>", i = 1; total >= i; i++)
                            currentClass = i == current ? " active" : "", html += "<div class='blobs" + currentClass + "' data-nativedroid-screenslide-indicator='" + i + "'></div>";
                    ...
                    widgetsObj = nativeDroid.plugins.homescreen.container.find("[data-nativedroid-role='widget']"), widgetsObj.addClass("nativeDroidHomescreenWidget"), widgetsObj.each(function() {
                        type = $(this).data("nativedroid-widget-type"), type && nativeDroid.plugins.homescreen.widget[type] ? new nativeDroid.plugins.homescreen.widget[type].ini($(this)) : type && console.log(type + " - is not a valid nativeDroid homescreen widget.")
                ...
                }, widget: {clock: {container: !1, currentMin: 0, language: {set: "en", type: "short", en: {dayShort: ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"], dayLong: ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"], monthShort: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], monthLong: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"], order: function(e, t, n, i, o) {
                                    return t + ", " + o + " " + n
                                }}, de: {dayShort: ["So", "Mo", "Di", "Mi", "Do", "Fr", "Sa"], dayLong: ["Sonntag", "Montag", "Dienstag", "Mittwoch", "Donnerstag", "Freitag", "Samstag"], monthShort: ["Jan", "Feb", "Mrz", "Apr", "Mai", "Jun", "Jul", "Aug", "Sep", "Okt", "Nov", "Dez"], monthLong: ["Januar", "Februar", "M&auml;rz", "April", "Mai", "Juni", "Juli", "August", "September", "Oktober", "November", "Dezember"], order: function(e, t, n, i, o, a) {
                                    return t + ", " + n + ". " + o + " " + a
                                }}}, getTodayString: function(e, t, n, i) {
                        ...
                        }}, reader: {container: !1, type: "rss", source: !1, bindEvents: function() {
                        }, create: function() {
                            ...
                            if (feedTitle = !1, feedLink = !1, feedDescription = !1, feedAuthor = !1, e && "200" == e.responseStatus) {
                                for (e = e.responseData.feed, feedTitle = e.title, feedLink = e.link, feedDescription = e.description, feedAuthor = e.author, feedHTML = "", i = 0; e.entries.length > i; i++)
                                    entry = e.entries[i], feedHTML += "<li>", feedHTML += "<div class='feedActionBox'><a href='" + entry.link + "' target='_blank'><i class='icon-share-alt'></i></a></div>", feedHTML += "<strong>" + entry.title + "</strong>", feedHTML += "<p>" + nativeDroid.basic.dateFormat.format(entry.publishedDate) + " | " + entry.contentSnippet + "</p>", feedHTML += "</li>";
                        ...
                        }}, icon: {container: !1, iconType: "text", iconClass: "icon-question-sign", iconTitle: "Your Icon", iconLink: "#", bindEvents: function() {
                ...
                }}}, api: {get: function(e, t, n, i) {
                $.ajax({dataType: e, url: t, data: n !== !1 ? n : "", success: i, error: function(e) {
                        console.log("There is an error while your ajaxRequest: "), console.log("Query: " + t), console.log(e.responseText)
                    }})
            }, helper: {googlemaps: {apiScript: "https://maps.googleapis.com/maps/api/js?v=3.exp&sensor=false", apiScriptLoaded: !1, ini: function(e) {
                        "undefined" == typeof google ? $.getScript(nativeDroid.api.helper.googlemaps.apiScript).done(function() {
                            e(!0)
                        }) : e(!0)
                    }, directions: {from: !1, to: !1, container: !1, type: "string", prepareRoute: function(e) {
                            ...
                            e && e.from && e.to && e.container && (nativeDroid.api.helper.googlemaps.directions.prepareRoute(e), $(window).on("load", function() {
                                function t() {
                                    var t = {zoom: 7, disableDefaultUI: !0, draggable: !1, keyboardShortcuts: !1, scrollwheel: !1, mapTypeId: google.maps.MapTypeId.ROADMAP};
                                    i = new google.maps.Map(e.container, t), a.setMap(i), n()
                                }
                                function n() {
                                    var e = {origin: nativeDroid.api.helper.googlemaps.directions.from, destination: nativeDroid.api.helper.googlemaps.directions.to, travelMode: google.maps.TravelMode.DRIVING};
                                    r.route(e, function(e, t) {
                                        t == google.maps.DirectionsStatus.OK && a.setDirections(e)
                                    })
                                }
                                var i, o = {draggable: !1}, a = new google.maps.DirectionsRenderer(o), r = new google.maps.DirectionsService;
                                t()
                            }))
