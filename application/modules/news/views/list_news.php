...
<?php if ($type == 2) {
    ?>
    <a href="javascript:void(0)" id="news-add-form" class="button bg-color-yellow"><i class="icon-plus"></i>Buat Info Beasiswa</a>
    <?php
}
?>
<?php if ($type == 3) {
    ?>
    <a href="javascript:void(0)" id="news-add-form" class="button bg-color-yellow"><i class="icon-plus"></i>Buat Info Fitur</a>
    <?php
}
?>
<?php if ($type == 1 + 3) {
    ?>
    <a href="javascript:void(0)" id="news-add-form" class="button bg-color-yellow"><i class="icon-plus"></i>Buat Info Sakola</a>
    <?php
}
?>
<?php if ($type == 2 + 3) {
    ?>
    <a href="javascript:void(0)" id="news-add-form" class="button bg-color-yellow"><i class="icon-plus"></i>Buat Info Karir</a>
    <?php
}
?>
<?php if ($type == 3 + 3) {
    ?>
    <a href="javascript:void(0)" id="news-add-form" class="button bg-color-yellow"><i class="icon-plus"></i>Buat Info Blog</a>
    <?php
}
?>
<?php if ($type == 1 + 6) {
    ?>
    <a href="javascript:void(0)" id="news-add-form" class="button bg-color-yellow"><i class="icon-plus"></i>Buat Info Pengembangan</a>
    <?php
}
?>
<?php if ($type == 2 + 6) {
    ?>
    <a href="javascript:void(0)" id="news-add-form" class="button bg-color-yellow"><i class="icon-plus"></i>Buat Info Kerjasama</a>
    <?php
}
?>
<?php if ($type == 3 + 6) {
    ?>
    <a href="javascript:void(0)" id="news-add-form" class="button bg-color-yellow"><i class="icon-plus"></i>Buat Info Sponsor dan Pendanaan</a>
    <?php
}
?>
