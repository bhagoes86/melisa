    ...
    <body>
        <div data-role="page" id="page" data-theme="d">
            ...
            <div data-role="header" data-tap-toggle="false" data-theme='b'>
                ...
                <a href="javascript:void(0)" data-ajax="false"><i class='icon-thumbs-up'></i></a>
            </div>
            <!--Panel-->
            <?php echo $this->load->view('panel_left'); ?>
            <!--Content-->
            <div data-role="content" style="text-align: center;" >
                <div style="margin-top: 10px;" class="span6 fb-like-box" data-width="100%" data-href="http://www.facebook.com/npaperbox" data-height="300" data-show-faces="true" data-stream="false" data-header="false"></div>
            </div>
        </div>
