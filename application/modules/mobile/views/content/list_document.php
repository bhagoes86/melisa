                ...
                <ul data-nativedroid-plugin='cards' id="main_content">
                    <?php foreach ($document as $rowdocument): ?>
                        <li data-cards-type='text'>
                            <?php if ($rowdocument->type == 1) { ?><!--Video-->
                                <h2><i class="icon-film"></i> Video Content</h2>
                                <a href="<?php echo site_url('mobile/viewer_video' . '/' . $rowdocument->id_content) ?>" data-ajax="false">
                                    <img id="cover_<?php echo $rowdocument->id_content ?>" src="<?php echo base_url() . 'resource' . '/' . $rowdocument->cover . '.jpg' ?>" style="width: 100%;">
                                </a>
                            <?php } elseif ($rowdocument->type == 2) { ?><!--Youtube-->
                            <?php } ?>
