                        ...
                        <div class="row" style="margin-top: 12px;">
                            <div class="span12">
                                ...
                                <div id="other-left" class="span6">
                                    ...
                                    <?php //echo modules::run('content/btn_share', site_url('content/docstoc' . '/' . $content->id_content)) ?>
                                </div>
                                <div id="other-right" class="span6" style="padding-top: 10px;">
                                    <table id="table-soundcloud-other">
                                        <?php foreach ($other_content as $row): ?>
                                            <tr>
                                                <td>
                                                    <a style="color: #095b97;font-size: 18px;" href="<?php echo site_url('content/docstoc' . '/' . $row->id_content) ?>">
                                                        <?php echo $row->title ?>
                                                    </a><br/>
