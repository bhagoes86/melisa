...
class Feed extends MX_Controller {
    ...
    // default konten untuk feed ini adalah 'feed/feeds' yakni fungsi feeds di controller ini
    ...
    function latest(){
    	...
    	$this->template
    			->set('title', 'Latest Feed') // judul konten
    			...
    			->build('layout'); // ini layout-modul buat latest
    }
