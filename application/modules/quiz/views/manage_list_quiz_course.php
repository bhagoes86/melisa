...
<div class="span8">
<h2>Daftar Kuis - <?php echo $course_id; ?></h2>
<hr>
        ...
        <?php foreach ($list_quiz as $quiz): ?>
            <tr>
                ...
                <td style="width: 30px;border: 1px solid white;vertical-align: middle;background-color:rgba(0, 0, 0, 0.0666667);">
                    <a title="Next" href="javascript:void(0)" id="btn-delete" data-id="<?php echo $quiz->id_quiz; ?>"><i class="icon-arrow-right-2 fg-color-red"></i></a>
                </td>
...
<script type="text/javascript">
    ...
    $('a#btn-delete').click(function(){
        ...
        $('#content-right').load("<?php echo site_url('quiz/show_manage_course_group') ?>/"+id_quiz+"/<?php echo $course_id?>",function(){
            $('#loading-template').fadeOut("slow");
        });
    });
