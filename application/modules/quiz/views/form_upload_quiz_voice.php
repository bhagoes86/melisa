<div class="span8">
    <h2>Form Upload Voice</h2>
    <form id="do-upload-video" method="POST" accept-charset="utf-8" enctype="multipart/form-data">
        <div class="input-control">
            <label>Pilih file video Anda (file video harus bertipe .mp3)</label><br/>
            <input name="userfile" type="file" id="userfile"/>
        </div>
        <div class="input-control text">
            <input name="title" id="title" type="text" placeholder="Judul Suara"/>
    ...
    <script type="text/javascript">
        ...
        $('#do-upload-video').submit(function(){
            ...
            $.ajaxFileUpload({
                url:"<?php echo site_url('quiz/upload_sound'); ?>",
                secureuri:false,
