...
<form id="update-quiz">
    ...
    <h4 style="margin-top: 0px;padding-top: 0px;">Jumlah Jawaban Per Soal : </h4>
    <div class="input-control select span1">
        <select name="max_answer_show" id="max_answer_show">
            <?php 
                for ($i=2; $i <= $count_choice; $i++){

                    if ($i == $max_answer_show){
                        ?>
