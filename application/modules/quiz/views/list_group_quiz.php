<a class="button bg-color-green fg-color-white" id="quiz-back-btn" data-id="<?php echo $quiz_id; ?>" ><i class="icon-arrow-left-2" ></i>Kembali ke Kuis</a>
...
<script type="text/javascript">
    ...
    $('#accept-confirm-message').click(function(){
            ...
            $.ajax({
                type:'POST',
                url:"<?php echo site_url('quiz/delete_group') ?>/"+id_group,
                data:id_group,
    ...
    $('a#btn-edit').click(function(){
        ...
        var id_group = $(this).attr('data-id');
        $('#content-right').load("<?php echo site_url('quiz/edit_group') ?>/"+id_group,function(){
            $('#loading-template').fadeOut("slow");
        });
    });
    ...
    $('#quiz-add-form').click(function(){
        ...
        $('#loading-template').show();
        $('#content-right').load("<?php echo site_url('quiz/show_add_group')."/".$quiz_id ?>",function(){
            $('#loading-template').fadeOut("slow");
        });
    });
