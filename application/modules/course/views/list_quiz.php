                ...
                if ($quiz->group_status == 1) {
                    ...
                    <tr>
                        ...
                        if ($this->session->userdata('data_quiz') != '') {
                            ...
                            <?php } else { ?>
                                <td class="center">
                                    <a title="Sedang Ditutup" href="javascript:void(0)" id="btn-preview" data-id="<?php echo $quiz->id_group; ?>"><i class="icon-locked fg-color-red"></i></a>
                                </td>
                                <?php
                            }
                        } else {
                            ...
                            if ($quiz->is_attempt == 2) {
                                ?>
                                <td class="center">
                                    <a title="Sudah Ditutup" href="javascript:void(0)" id="btn-preview" data-id="<?php echo $quiz->id_group; ?>"><i class="icon-locked fg-color-red"></i></a>
                                </td>
                                <?php
                            } else {
