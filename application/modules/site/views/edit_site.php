...
<form id="do-edit-header" method="POST" accept-charset="utf-8" enctype="multipart/form-data">
    <h3 style="margin-top: 0px; padding-top: 0px;">Header</h3>
    <div class="input-control text span6">
        <input name="header" id="header" type="text" placeholder="Header" value="<?php echo $content->header; ?>" style="margin-bottom: 10px"/>
...
<form id="do-edit-footer" method="POST" accept-charset="utf-8" enctype="multipart/form-data">
    <h3 style="margin-top: 0px; padding-top: 0px;">Footer</h3>
    <div class="input-control textarea span6">
        <textarea name="footer" id="footer" placeholder="Footer"resize: vertical style="margin-bottom: 10px"><?php echo $content->footer; ?></textarea>
        <input type="submit" value="Submit"/>
    </div>   
</form>
<div class="clearfix"></div>
...
<form id="do-edit-bheader" method="POST" accept-charset="utf-8" enctype="multipart/form-data">
    <h3 style="margin-top: 0px; padding-top: 0px;">Background Header</h3>
    <div class="input-control text span6">
        <input name="bgheader"  maxlength="6" size="6" id="bgheader" type="text" placeholder="Backgroung header" value="<?php echo $content->bgheader; ?>" style="margin-bottom: 10px"/>
        <input type="submit" value="Submit"/>
    </div>
</form>
...
<form id="do-edit-bfooter" method="POST" accept-charset="utf-8" enctype="multipart/form-data">
    <h3 style="margin-top: 0px; padding-top: 0px;">Background Footer</h3>
    <div class="input-control text span6">
        <input name="bgfooter" maxlength="6" size="6" id="bgfooter" type="text" placeholder="Background footer" value="<?php echo $content->bgfooter; ?>" style="margin-bottom: 10px"/>
        <input type="submit" value="Submit"/>
    </div>
</form>
<div class="clearfix"></div>
...
<script type="text/javascript">
    ...
    $('#do-edit-site').submit(function(){        
        $('#loading-template').show();
        $('#message').html("Loading Data");
        $.ajax({
            type:'POST',
            url:"<?php echo site_url('site/update_site'); ?>",
            data:$(this).serialize(),
