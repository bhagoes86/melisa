(function($){
    $.fn.flexipage=function(options){
        ...
        return this.each(function(){
            ...
            if(opts.pager==true){
                ...
                var pagerHTML='<li class="prev"><a href="javascript:void(0)" class="button bg-color-blue fg-color-white">'+opts.prev_txt+"</a></li>"+opts.showcounter+'<li class="next"><a href="javascript:void(0)" class="button bg-color-blue fg-color-white">'+opts.next_txt+"</a></li>";
    ...
    $.fn.flexipage.defaults={
        element:"li",
        pager:true,
        prev_txt:"<i class='icon-arrow-left-2'></i>",
        next_txt:"<i class='icon-arrow-right-2'></i>",
